...
class BillingPay extends StatefulWidget {
  BillingPay({Key? key}) : super(key: key);

  @override
  State<BillingPay> createState() => _BillingPayState();
}

class _BillingPayState extends State<BillingPay> {
  ...
  method() async {
    ...
    var get_bill_item_list = storage.getItem('billing_list_item');

    var data = {
      "main_id": get_bill_item_list['id'],
      "type": get_bill_item_list['plan_type'],
    };

    var get_billingPayLog =
        await BillingMethodApi().getPayBillingLog(accessToken, context, data);
            ...
            child: !isLoading
                ? Column(
                    children: [
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    "${billingPayLog['total_amount'].toString()}"),
                                              ],
                                            ),
                                            Row(
                                              mainAxisAlignment:
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                    "Total paid (₹): ${billingPayLog['paid_amount']}"),
                                                SizedBox(
                                                  height: 20,
                                                  child: TextButton(
                                                    onPressed: () {
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                    "Balance Amount (₹): ${billingPayLog['balance']}"),
                                                Text(""),
                                              ],
                                            ),
                                          ],
                          ...
                          ? Container(
                              child: billingPayLog['billing_log'].length > 0 && billingPayLog ['billing_log'] != "No Transcation"
                                  ? ListView.builder(
                                      ...
                                      itemCount:
                                          billingPayLog['billing_log'].length,
                                      itemBuilder:
                                          (BuildContext context, int index) {
                                        var data =
                                            billingPayLog['billing_log'][index];
                                        return Padding(
                                          padding: const EdgeInsets.all(3.0),
                                          child: Container(
                                            decoration: BoxDecoration(
                      ...
                      SizedBox(height: 20),
                      bill_item_list['pay_status'] == 'Pending'
                          ? SizedBox(
                                          ...
                                          if (payDropdownvalue ==
                                            ...
                                            var data = {
                                              ...
                                              "balance_received":
                                                  balanceReceivedController
                                                      .text,
                                              "main_id": bill_item_list['id']
                                                  .toString(),
                                              "plan_type":
                                                  bill_item_list['plan_type']
                                                      .toString(),
                                            };

                                            var result =
                                                await BillingMethodApi()
                                                    .billingPayApi(accessToken,
                                                        context, data);
