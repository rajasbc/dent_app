...
class _DiagnosisListState extends State<DiagnosisList> {
          ...
          child: AppBar(
            ...
            leading: IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const DentalPlan()),
                  );
                },
            ...
            ? Container(
                ...
                child: Column(
                  children: [
                    ...
                    widget.option == 'diagnosis'
                        ? Container(
                            height: screenHeight * 0.89,
                            width: screenWidth,
                            child: Helper().isvalidElement(diagnosisList) &&
                                    Helper()
                                        .isvalidElement(diagnosisList.values) &&
                                            ...
                                            Container(
                                              ...
                                              child: Padding(
                                                padding: const EdgeInsets.only(
                                                    ...
                                                    bottom: 15.0),
                                                child: Text(
                                                    '${index + 1}. ${diagnosisList.values.toList()[0][index]['diagnosis_name'].toString()}'),
                                              ),
                                            ),
                                            SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                onPressed: () async {
                                                  if (Helper().isvalidElement(
                                                      ...
                                                      selectedTeeth.length >
                                                          0) {
                                                    List<SelectedTeethModal>
                                                        selected_teeth_values =
                                                        [];
                                                    var selectedPatient =
                                                        storage.getItem(
                                                            'selectedPatient');
                                            ...
                                            Container(
                                              ...
                                              child: Padding(
                                                padding: const EdgeInsets.only(
                                                    ...
                                                    bottom: 15.0),
                                                child: Text(
                                                    '${index + 1}. ${treatmentList[index]['treatment_name'].toString()}'),
                                              ),
                                            ),
                                            SizedBox(
                                              width: screenWidth * 0.01,
  ...
  getDiagnosisList() async {
    ...
    if (Helper().isvalidElement(diagnosisList) &&
        ...
        diagnosisList['status'] == 'Token is Invalid') {
...
// }
            ...
            list.map((day, items) {
              return new MapEntry(
                  day,
                  items.where((i) {
                    return i.diagnosis_name.toString().contains(text)
                        ? true
                        : false;
                  }).toList());
            });
